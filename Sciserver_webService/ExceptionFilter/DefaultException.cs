...
{
    public class DefaultException : ExceptionFilterAttribute
    {
        ...
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            else
            {
                ...
                context.Response = DefaultHandler(
                    context.Exception.GetBaseException(), context.Request
                );
            }

        }

        public DefaultException Register<TException>(Func<Exception, HttpRequestMessage, HttpResponseMessage> handler)
