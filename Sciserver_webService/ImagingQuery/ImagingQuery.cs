...
//namespace Sciserver_webService.ImagingQuery
//{
//    public class ImagingCone
//    {            
...
//        private static string getConeQuery(string type, bool targdb, string raCenter, string decCenter, string radius) {
...
//        private static Dictionary<string, string> getDefaultCone() {
//            Dictionary<string, string> dictionary = new Dictionary<string, string>();
//            dictionary.Add("limit","50");
//            dictionary.Add("imgparams", "minimal");
//            dictionary.Add("specparams", "none");
//            dictionary.Add("positionType", "cone");
//            return dictionary;
//        }
//        public static string BuildConeQuery(string type, Dictionary<string, string> dictionary)
//        {
//            Dictionary<string, string> def = getDefaultCone();
//            //update dictionary
//            foreach (string s in def.Keys) {
//                if (!dictionary.Keys.Contains(s)) {
//                    dictionary.Add(s, def[s]);
//                };
//            }
//            return buildCone(type, dictionary);
//        }
...
//        public static string buildCone(string type,   Dictionary<string,string> dictionary)
//        {
//            string orderClause = "";
//            string cmd = "";
//            string specAlias = "s";
...
//                            joinClause += getConeQuery(type,false,dictionary["ra"],dictionary["dec"],dictionary["radius"]);
...
//                //proxCmd = readProxText(oConn, proxList, objType, proxRad, targdb, type, nearBy);
