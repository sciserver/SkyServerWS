...
namespace Sciserver_webService.Controllers
{
    public class NoPositionIRController : ApiController
    {
        ...
        //public HttpResponseMessage get(String imaging, String spectroscopy, String magColorType,
        ...
        //                               String objType, String score, String objFlags)
        public HttpResponseMessage get(String limit = "50", String imgparams = "", String specparams = "", String magColorType = "",
                                    ...
                                    String iColor = "", String rColor = "", String zColor = "", String objType = "", String score = "", String flagsOnList = "", String flagsOffList = "") 
        {
            ...
            if (ControllerContext.Request.Headers.TryGetValues("X-Auth-Token", out values))
            {
                ...
                string query = QueryTools.BuildQuery.buildQuery("img", dictionary,"noposition");
