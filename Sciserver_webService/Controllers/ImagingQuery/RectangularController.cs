...
namespace Sciserver_webService.Controllers
{
    public class RectangularController : ApiController
    {
        ...
        public HttpResponseMessage get(String raMin = null, String decMin = null, String raMax = null, String decMax=null, String limit = "50", String imgparams = "", String specparams = "", String magColorType = "",
                                   ...
                                   String iColor = "", String rColor = "", String zColor = "", String objType = "", String score = "", String flagsOnList = "", String flagsOffList = "") 
        {
            ...
            if (ControllerContext.Request.Headers.TryGetValues("X-Auth-Token", out values))
            {
                ...
                string query = QueryTools.BuildQuery.buildQuery("img", dictionary,"rectangular");
